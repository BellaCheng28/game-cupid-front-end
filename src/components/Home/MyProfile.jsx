...
>>>>>>> f0ddbb85fb0270509cf97579d8d4312c8f9787fa
  return (
    <div className="min-h-screen p-4 bg-gradient-to-b from-violet-950 to-violet-800 flex flex-row flex-wrap justify-evenly">
      ...
      <div className="w-full flex p-6 text-white bg-lightPurple rounded-lg shadow-lg max-w-[300px] max-h-[400px] flex-col items-center m-3">
        ...
        <div>
          ...
          <div className="bg-blue-500 rounded-lg px-6 py-1 text-center text-shadow-violet">
            {profile.username}
          </div>
        </div>
<<<<<<< HEAD
...
=======
        <div className="flex flex-col text-left w-full mt-6 space-y-2 px-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <p className="flex-1 text-xs">{profile.city || "Unknown"}</p>
          </div>
        </div>
      </div>
...
>>>>>>> f0ddbb85fb0270509cf97579d8d4312c8f9787fa
              ...
              >
                <span
                  className="bg-blue-500 rounded-lg px-3 py-1 text-shadow-violet inline-block m-2"
                  style={{ minWidth: "120px", maxWidth: "120px" }}
                >
                  {platform.brand}
                </span>
                <span
                  className="bg-blue-500 rounded-lg px-6 py-1 text-shadow-violet inline-block"
